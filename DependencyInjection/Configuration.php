                        ...
                        ->arrayNode('confirmation')
                            ...
                            ->children()
                                ...
                                ->arrayNode('form')
                                    ->addDefaultsIfNotSet()
                                    ->children()
                                        ->scalarNode('type')->defaultValue('fos_user_resend_confirm')->end()
                                        ->scalarNode('name')->defaultValue('fos_user_resend_confirm_form')->end()
                                        ->arrayNode('validation_groups')
                                            ->prototype('scalar')->end()
                                            ->defaultValue(array('ResendConfirm', 'Default'))
                                        ->end()
                                    ->end()
                                ->end()
                            ->end()
